...
class CrmItem extends Model
{
    ...
    {
        return $this->belongsTo(CrmCategory::class, 'crm_category_id');
    }
    ...
    {
        return $this->belongsTo(CrmItem::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(CrmItem::class, 'parent_id')->orderBy('place_number');
    }
